            ...
            verticalAlignment: VerticalAlignment.Bottom
                ...
                Container {
                    ...
                    TextField {
                        ...
                        onFocusedChanged: {
                            if(focused)
                                pic_slide.visible = false;
                            else
                                pic_slide.visible = true;
                        }
                    }
                    ...
                    Button {
                        ...
                        text: "Zu Folie"
                        onClicked: {
                            var slide = tex_abs_slide.text*1 - 1;
                            console.log("Versuche Slide auf " + slide + " zu setzen");
                            cl.requestSlideChangeAbsolute(slide);
                        }
                    }
